...
func (x *CreateArticleRequest) GetAuthorPhotoUrl() string {
	if x != nil {
...
func (x *GetArticleByIDResponse) GetAuthorPhotoUrl() string {
	if x != nil {
		return x.AuthorPhotoUrl
	}
	return ""
...
const file_article_service_article_service_proto_rawDesc = "" +
	"\n" +
	"%article_service/article_service.proto\x12\aarticle\x1a\x1fgoogle/protobuf/timestamp.proto\"\xae\x01\n" +
	...
	"\acontent\x18\x05 \x01(\tR\acontent\"\x17\n" +
